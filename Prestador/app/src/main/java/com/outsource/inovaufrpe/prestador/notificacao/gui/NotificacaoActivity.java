                ...
                viewHolder.setOnClickListener(new NotificacaoViewHolder.ClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        if (!notificacao.isLido()) {
                            databaseReference.child("notificacao").child("prestador").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(notificacao.getNotificacaoID()).child("lido").setValue(true);
                        }
                        startActivity(it);
                    }
